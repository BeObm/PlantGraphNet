...
if __name__ == "__main__":
    ...
    parser.add_argument("--type_graph", default="harris", help="define how to construct nodes and egdes", choices=["harris", "grid", "multi","grid2"])
    ...
    graph_constructor(dataset_path=f"{config['param']['train_image_dataset_root']}",
                                     args=args,
                                     type_dataset="train",
                                     apply_transform=True)
    graph_constructor(dataset_path=f"{config['param']['test_image_dataset_root']}",
                                     args=args,
                                     type_dataset="test",
