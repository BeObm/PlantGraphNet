...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_size", type=int, default=200, help="number of images to use for training/test per class; 0 means all")
    ...
    dataset_path = graph_constructor(config['param']["image_dataset_root"],config['param']["graph_dataset_name"],args.dataset_size)
